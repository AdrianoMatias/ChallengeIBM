...
<%@include file="bannerPrincipal.jsp"%>
	<div class="container">
	<h5>Email inexistente ou incorreto! Por favor cadastre-se.</h5>
		<div class="row">
			<div class="col">
				<!-- FORM DE CADASTRO  -->
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputAddress2">Email</label> <input type="text"
								class="form-control" id="email" placeholder="Entre com seu EMAIL."
								name="email" required onblur="valida('email');">
						</div>
