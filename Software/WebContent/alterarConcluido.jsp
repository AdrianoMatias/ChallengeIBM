							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label>Logradouro</label> <input id="logradouro" type="text"
										name="logr" class="form-control"
										value="${aluno.logr.replaceAll("
										_", " ").toUpperCase()  }"
										readonly="true" />
								</div>
								...
								<div class="form-group col-md-6">
									<label>Bairro</label> <input readonly="true" id="bairro"
										type="text" name="bairro" class="form-control"
										value="${aluno.bairro.replaceAll(" _", " ").toUpperCase()  }" />
								</div>

								<div class="form-group col-md-6">
									<label>Cidade</label> <input id="cidade" readonly="true"
										type="text" name="cidade" class="form-control"
										value="${aluno.cidade.replaceAll("_", " ").toUpperCase()  }" >
								</div>

								<div class="form-group col-md-6">
									<label>UF</label> <input id="uf" readonly="true" type="text"
										name="uf" class="form-control" value=${aluno.uf } />
								</div>
							</div>
						</form>
